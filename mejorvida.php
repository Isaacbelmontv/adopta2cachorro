    ...
    <div id="overlay">
      ...
      <div class="loader-cntn">
        <svg class="spinner" stroke="#000" width="200" height="200" viewBox="0 0 206 206" xmlns="http://www.w3.org/2000/svg">
          ...
          <!--<circle class="path" cx="103" cy="103" r="100" fill="none" stroke="#000" stroke-linecap="round" stroke-width="6" stroke-dasharray="0.001,17"/>-->
        </svg>
        ...
        <p class="TextUna">UnaMejorVida</p>
      </div>
...
<div class="contenido">
  <div class="mision">
    <h3 class="subtitulos" >MISIÓN</h3>
    <p>
    Somos una asociación sin fines de lucro que se preocupa y ocupa del bienestar de los animales. Lo más importante para nosotros es que nuestros compañeros de vida realmente tengan UNA MEJOR VIDA.
    </p>
  </div>
<div class="padreHistoria">
<div class="imagenHistoria">
  <img class="Beni" src="images/beni.jpg" width="600" height="300"alt="Benito">
</div>
  <div class="historia">
    <h3 class="subtitulos" >HISTORIA</h3>
    <p>
    Una Mejor Vida A.C. nació el 23 de Octubre del 2004 gracias a la iniciativa de personas preocupadas por el bienestar de los animales.
    </p>
  </div>
</div>

  <div class="colaboradores">
    <h3 class="subtitulos" >Colaboradores</h3>
    <p><i class="fa fa-male" aria-hidden="true"></i> Isaac Belmont</p>
    <p><i class="fa fa-female" aria-hidden="true"></i> Luisa Beatriz</p>
    <p><i class="fa fa-male" aria-hidden="true"></i> Carlos Arturo</p>
  </div>
</div>
<!--Contenido-->
<!--ftr-->
...
<script src='https://cdnjs.cloudflare.com/ajax/libs/snap.svg/0.4.1/snap.svg-min.js'></script>
  ...
  <!--Loader-->
    <script  src="js/loader_spinner.js"></script>
  <!--Loader-->
